  ...
  return (
    <div className=" flex items-center justify-center py-20 bg-gray-100">
      <div className="bg-white rounded-md flex flex-col gap-8  py-6 w-[80%] md:w-[65%] px-10 ">
        ...
        <h4 className="font-semibold text-xl">The significance of data privacy from a user and business perspective is as follows:-</h4>
        <h4 className="font-semibold text-xl">For Individuals</h4>
        ...
        <h4 className="font-semibold text-xl">From a Business Perspective</h4>
        ...
        <h4 className="font-semibold text-xl">Data-Driven Innovation</h4>
        ...
        <h4 className="font-semibold text-xl">A Case of Data-Driven Optimization</h4>
        ...
        <h4 className="font-semibold text-xl">Holistic Approach to Data Privacy</h4>
        <p>The three core pillars need to be understood by associations to borrow this approach to data security:-</p>
        <h4 className="font-semibold text-xl">Sensitive data needs to be discovered and classified</h4>
        ...
        <h4 className="font-semibold text-xl">Securing Sensitive data:</h4>
        ...
        <h4 className="font-semibold text-xl">Enforcement of Holistic Data Protection Strategy</h4>
        <ul>
        ...
        <h4 className="font-semibold text-xl">Conclusion</h4>
